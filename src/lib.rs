...
#[derive(Debug)]
pub struct DataForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DataForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DataForge processing");
    
    let mut processor = DataForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DataForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DataForgeProcessor::new(false);
